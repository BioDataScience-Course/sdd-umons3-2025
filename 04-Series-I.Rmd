...
Ce module nécessite d'être à l'aise avec R, RStudio et R Markdown. Les cinq premiers modules du cours 1 (en particulier, la `r course_link("visualisation", 1,page = "introvisu")` et le `r course_link("visualisation", 1,page = "import")`) doivent être acquis. La notion de corrélation (`r course_link("partie du module 6 du cours 1", 1,page = "correlation")`) doit également être bien comprise au départ.
