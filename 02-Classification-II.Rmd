...
Dans ce second jeu de données, nous avons pu tout de même conserver `r nrow(pima2)` cas. `r course_link("L'ACP que nous avions réalisée sur ces données", 2, "analyse-en-composantes-principales")`
