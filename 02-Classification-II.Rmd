...
## Validation croisée {#validationcroisee}
...
`r h5p(183, "C02Ha_validation_croisee", height = 270, toc = "Principe de la validation croisée.")`
...
`r h5p(184, "C02Hb_valid_exclusion", height = 270, toc = "Principe de la validation par exclusion d'une donnée.")`
...
`r h5p(185, "C02Hc_cvpredict", height = 270, toc = "Utilisation de la fonction cvpredict().")`
...
## Différents algorithmes {#diffalgorithmes}
...
`r h5p(186, "C02Hd_knn", height = 270, toc = "Principe des K plus proches voisins")`
...
`r h5p(187, "C02He_lvq", height = 270, toc = "Principe de la quantification vectorielle")`
...
if (exists("assignment"))
  assignment("C02Ia_zoo", part = NULL,
    ...
    course.urls = c(
      'S-BIOG-025'         = !"{assign_url$C02Ia_zoo}"),
    course.starts = c(
      'S-BIOG-025'         = !"{class1_start(mod, 'C02')}"),
    course.ends = c(
      'S-BIOG-025'         = !"{n3_end(mod, 'C02')}"),
    term = "Q1", level = 3,
    toc = "Création d'un classifieur optimal")
```

## Partitionnement récursif {#partirecursif}
...
## Forêt aléatoire {#foretaleatoire}
...
### Pima avec forêt aléatoire {#pimaforetaleatoire}
...
`r h5p(188, "C02Hf_mlRforest", height = 270, toc = "La fonction mlRforest()")`
...
`r h5p(189, "C02Hg_type_algo", height = 270, toc = "Les types d'algorithmes")`
...
## Optimisation et métriques {#optimetriques}
...
## Récapitulatif des exercices {#recapitulatifc02}
