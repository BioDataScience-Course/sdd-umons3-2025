...
-   `r course_link("Acquisition de données", 1,page = "acquisition")`

-   `r course_link("Encodage des données dans un tableau cas par variables", 1, page = "tableaudonnees", anchor = "tableaux-cas-par-variables" )`

-   `r course_link("Ajout de métadonnées", 1, page = "tableaudonnees",anchor = "m%C3%A9tadonn%C3%A9es" )` avec utilisation d'un `r course_link("dictionnaire des données", 1, page = "tableaudonnees",anchor = "dictionnaire-des-donn%C3%A9es" )`

Il est de plus intéressant de pouvoir rendre les données de sa recherche accessibles en respectant les normes et les règles de l'`r course_link("Open Data", 2, page = "donneesouvertes")`.
