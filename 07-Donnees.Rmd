...
Dans ce module, nous traiterons de données particulières telles que les dates, les variables circulaires et le texte. Il n'est pas toujours évident de manipuler de telles données et vous apprendrez quelques outils et astuces qui vont vous faciliter le travail.
...
Vous devez être à l'aise dans l'utilisation de R et de RStudio pour des tâches courantes (importer et manipuler des données numériques ou qualitatives, utiliser les projets RStudio, git et GitHub, réaliser des analyses reproductibles avec Quarto et R Markdown).
...
`r h5p(151, "D07Ha_date", height = 270, toc = "Nombre de jours dans une année")`
...
### Conversion d'une chaîne de caractères en date {#conversiondate}
...
`r h5p(152, "D07Hb_conversion_date2", height = 270, toc = "Fonctions de conversion en dates")`
...
`r h5p(153, "D07Hc_lubridate", height = 270, toc = "Conversion de date avec lubridate")`
...
if (exists("assignment"))
  assignment("D07Ia_data", part = "I",
    ...
    course.urls = c(
      'S-BIOG-043'         = !"{assign_url$D07Ia_data}"),
    course.starts = c(
      'S-BIOG-043'         = !"{class1_start(mod, 'D07')}"),
    course.ends = c(
      'S-BIOG-043'         = !"{n3_end(mod, 'D07')}"),
    term = "Q1", level = 3,
    toc = "Données, partie I : dates")
```

## Données textuelles {#donneestextuelles}
...
### Expression régulière {#expressionreguliere}
...
## Variables circulaires {#varcirculaires}
...
## Récapitulatif des exercices {#recapitulatifd07}
