...
link-citations: yes
github-repo: 'BioDataScience-Course/sdd-umons3-2025'
...
Cet ouvrage interactif est le troisième volume d'une série de trois ouvrages traitant de la science des données biologiques. L'écriture de cette suite de livres a débuté au cours de l'année académique 2018-2019. Pour l'année académique 2025-2026, cet ouvrage interactif est le support des cours suivants :

-   [Science des données III : exploration et prédiction](https://webcontent.umons.ac.be/web/fr/pde/2025-2026/ue/US-M1-BIOL60-004-M.htm) (SDD III) aux premiers Masters BBMC (Biochimie, Biologie Moléculaire et Cellulaire) et BOE (Biologie des Organismes et Écologie) en Faculté des Sciences de l'Université de Mons, et dont le responsable est Philippe Grosjean
...
-   [Science des données IV : recherche reproductible](https://webcontent.umons.ac.be/web/fr/pde/2025-2026/ue/US-M2-BIOEFA-015-M.htm) (SDD IV) cours à option donné aux deuxièmes années des mêmes Masters, et dont le responsable est également Philippe Grosjean
...
Une présentation des changements introduits par rapport à l'année précédente vous est faite durant la première séance introductive. La présentation correspondante est disponible au format PDF [ici](https://github.com/BioDataScience-Course/sdd_lessons/raw/2025-2026/C00/presentations/C00Pa_intro.pdf).
...
-   [Plan du cours de Science des données biologiques III : années 2025-2026](https://github.com/BioDataScience-Course/BioDataScience-Common/tree/2025-2026/docs/plan_de_cours/sdd3_plan_cours_2025-2026.pdf)
...
if (exists("assignment2"))
  assignment2("C00Ga_issues", part = NULL, clone = FALSE,
    url = "https://github.com/BioDataScience-Course/C00Qa_25M_issues-c25",
    course.ids = c(
...
if (exists("assignment2"))
  assignment2("D00Ga_issues", part = NULL, clone = FALSE,
    url = "https://github.com/BioDataScience-Course/D00Qa_25M_issues-d25",
    course.ids = c(
