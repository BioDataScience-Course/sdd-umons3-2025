...
```{block, type="warning"}
Au final, vous verrez que R n'est pas homogène. R est un langage qui évolue au cours du temps et ce depuis 1993, ce qui explique ce manque d'homogénéité. Cependant, restez cohérent, fixez vous vos propres conventions et respectez-les. 
...
## Documenter sa fonction {#documenter}
...
```{r assign_D08Ga_project_II, echo=FALSE, results='asis'}
if (exists("assignment"))
  assignment("D08Ga_project", part = "II",
    ...
    term = "Q1", level = 4, n = 1,
    toc = "Organisation d'un projet (partie II)")
```
...
## Récapitulatif des exercices {#recapitulatifd09}

Dans ce module 9, vous aviez à réaliser les exercices suivants :
